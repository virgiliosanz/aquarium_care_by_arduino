...
void setup() {
	...
	sensors_data.ds18b20.time_between_reads = defaults::ds18b20_conf.time_between_reads;
...
#define SHOULD_READ(last_read, time_between_reads)                             \
	...
	if (SHOULD_READ(sensors_data.ds18b20.last_read,
		...
		sensors_data.ds18b20.internal = sensors.getTempCByIndex(outsideThermometer_id);
